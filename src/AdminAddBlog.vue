<template>
  <div class="form-wrapper">
    <div class="form-container">
      <h2 class="form-title">✍️ Add New Blog Post</h2>
      ...
      <button @click="submitBlog" class="publish-btn" :disabled="!title || !content || !thumbnail">
    ...
    async submitBlog() {
      ...
      try {
        ...
        if (error) {
          ...
          this.msg = "Blog Published successfully! Redirecting...";
